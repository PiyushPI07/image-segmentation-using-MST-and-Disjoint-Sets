...
if __name__ == '__main__':
    ...
    parser.add_argument('--min-comp-size', type=int, default=1000, 
                        help='a constant to remove all the components with fewer number of pixels')
    parser.add_argument('--input-file', type=str, default="../images/seg_test.jpg", 
                        help='the file path of the input image')
    parser.add_argument('--output-file', type=str, default="../images/seg_test_out.jpg", 
